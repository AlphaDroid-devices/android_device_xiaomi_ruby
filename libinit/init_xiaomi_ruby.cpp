...
static const variant_info_t rubypro_global_info = {
    ...
    .marketname = "Redmi Note 12 Pro+ 5G",
    .model = "22101316UG",
    .build_fingerprint = "Redmi/rubypro_global/rubypro:14/UP1A.230620.001/V816.0.4.0.UMOMIXM:user/release-keys"
};
...
static const variant_info_t rubyplus_info = {
    ...
    .model = "22101316UC",
    .build_fingerprint = "Redmi/rubyplus_global/rubyplus:14/UP1A.230620.001/V816.0.4.0.UMOMIXM:user/release-keys"
};
